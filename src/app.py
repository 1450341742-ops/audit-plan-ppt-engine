...
st.set_page_config(page_title="稽查总结会PPT生成器 V8.13", layout="centered")
st.title("稽查总结会PPT生成器 V8.13（直接生成版）")
st.caption("系统已内置稽查总结会PPT模板，只需上传Excel表格即可直接生成PPT，不调用AI总结。")
...
st.info("生成PPT后，TOP5页只展示高风险问题、风险维度分析和核查应对建议，不展示生成来源说明。")
